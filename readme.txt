...
Dentro de la clase main se han creado 2 clases de columnas, columna_izq, en donde representa la columna izquierda donde se encuentra definido el menú de opciones y columna_der, la columna derecha donde se encuentra definido el contenido de la página (Formulario, resultados de búsqueda, mapas, etc.)
